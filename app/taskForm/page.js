...
//     setCurrentStartTime(now.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false }));
//     setCurrentEndTime(now.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false }));
...
//     const selectedStartTime = new Date(`${formData.startDate} ${convertTo24HourFormat(currentStartTime)}`);
